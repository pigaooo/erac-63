@component('emails.layout', [
    ...
    'heroText' => 'Seu pagamento foi identificado e o credenciamento do participante esta confirmado no ERAC.',
    'inscrito' => $inscrito,
])
    ...
    <p style="margin:0 0 18px 0; font-size:16px; line-height:1.8; color:#382214;">
        Confirmamos o pagamento da sua inscricao. Seu credenciamento esta validado no sistema.
    </p>
        ...
        <tr>
            <td style="padding:20px 22px;">
                ...
                <div style="font-size:16px; line-height:1.75; color:#f3fff4;">
                    Pagamento aprovado. Leve esta confirmacao no celular para agilizar seu check-in no evento.
                </div>
            </td>
        </tr>
    </table>
